		...
		<>
			...
			<Layout>
				<div className={utilStyle.container}>
					...
					<form
						action="https://formcarry.com/s/-QvpqQhONcK"
						method="POST"
					...
					>
						...
						<div className={contactStyle.row}>
							<div className={contactStyle.group}>
								...
								<input
									type="text"
									name="name"
									className={contactStyle.control}
									id="name"
									required
								/>
							</div>
						...
						<div className={contactStyle.group}>
							<label
								className={contactStyle.content}
								for="name"
							>
								Content :
							</label>
					...
					<ul className={contactStyle.contactContainer}>
						<li
							className={
								contactStyle.contactContainerElement
							}
						>
							<a
								href="https://github.com/TakshakRamteke"
								target="_blank"
							>
						...
						>
							<a
								href="https://twitter.com/TakshakRamteke"
								target="_blank"
							>
						...
						>
							<a
								href="mailto:takshakramteke0708@gmail.com"
								target="_blank"
							>
